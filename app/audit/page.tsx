...
const EVIDENCE_ITEMS = [
    {
        ...
        // Replace src with your actual image path, e.g. "/images/evidence-slow.png"
        src: "",
    },
    {
        ...
        <main className="min-h-screen bg-[#f7f7f5] text-[#1a1a1a] font-[family-name:var(--font-poppins)] selection:bg-primary/20">
            ...
            <section className="py-20 md:py-28" id="audit-form">
                <div className="max-w-[960px] mx-auto px-6">
                    ...
                    <Reveal delay={0.05}>
                        <h2 className="text-3xl sm:text-4xl md:text-[44px] font-extrabold tracking-tight leading-tight text-[#1a1a1a] text-center capitalize">
                            We&apos;ll Audit Your Website for Free
                        </h2>
                    </Reveal>
                    <Reveal delay={0.1}>
                        <p className="text-[#888] text-center text-base mt-3 mb-12 max-w-md mx-auto">
                    ...
                    <Reveal delay={0.15}>
                        <div className="max-w-lg mx-auto bg-[#f7f7f5] rounded-xl p-8 md:p-10">
                            {!formSubmitted ? (
                                <form onSubmit={handleSubmit} className="space-y-5">
                                    <FormField label="Your Name" required>
                                        <input
                                            ...
                                            className="w-full bg-white border border-[#e5e5e0] rounded-lg px-4 py-3.5 text-sm text-[#1a1a1a] placeholder:text-[#ccc] focus:outline-none focus:border-primary transition-colors"
                                        />
                                    </FormField>
                                    ...
                                    <FormField label="Business Type">
                                        <select
                                            name="type"
                                            defaultValue=""
                                            className="w-full bg-white border border-[#e5e5e0] rounded-lg px-4 py-3.5 text-sm text-[#1a1a1a] focus:outline-none focus:border-primary transition-colors appearance-none"
                                            style={{
            ...
            <footer className="border-t border-[#e5e5e0] py-10 bg-white">
                <div className="max-w-[960px] mx-auto px-6 text-center">
                    <Link
                        href="/"
                        className="text-lg font-bold inline-block mb-2 text-[#1a1a1a]"
                    >
                        <span className="text-primary">Mutant</span> Technologies
                    </Link>
